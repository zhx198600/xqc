$(function() {
    ...
    if(!$('html.no-online').length){
        online_html+= '<li><button type="button" class="btn btn-icon btn-info btn-squared font-size-30" id="btn-meqia" title="在线客服" onclick="_MEIQIA._SHOWPANEL()"><i class="icon w-30 fa-commenting" aria-hidden="true"></i></button></li>'
                    +'<li><a href="http://crm2.qq.com/page/portalpage/wpa.php?uin=4000084433&aty=0&a=0&curl=&ty=1" title="QQ客服" class="btn btn-icon btn-info btn-squared font-size-30" target="_blank"><i class="icon w-30 fa-qq" aria-hidden="true"></i></a></li>'
                    +'<li><a href="'+M['accurl']+'profile/process/" title="售后工单" class="btn btn-icon btn-info btn-squared font-size-30" target="_blank"><i class="icon w-30 fa-wrench" aria-hidden="true"></i></a></li>';
        if($('#indexFeed').length) online_html+= '<li><button type="button" class="btn btn-icon btn-info btn-squared font-size-30 feed-online" title="在线反馈" data-toggle="modal" data-target="#indexFeed" data-backdrop="false"><i class="icon w-30 fa-pencil" aria-hidden="true"></i></button></li>';
    }
    online_html+= '<li><button type="button" class="btn btn-icon btn-info btn-squared font-size-30 met-scroll-top" title="返回顶部" onclick="goTop()"><i class="icon w-30 wb-chevron-up" aria-hidden="true"></i></button></li></ul></div>';
